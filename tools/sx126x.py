# This file was downloaded from the Waveshare guide - https://www.waveshare.com/wiki/SX1268_433M_LoRa_HAT
# and was modified for learning purposes.
...
# "20,868,Hello World"
    ...
    def receive(self):
        if self.ser.inWaiting() > 0:
            ...
            print("Received message from node address with frequency\033[1;32m %d,%d.125MHz\033[0m"%((r_buff[0]<<8)+r_buff[1],r_buff[2]+self.start_freq),end='\r\n',flush = True)
            # print("Message is - "+str(r_buff[3:-1]),end='\r\n')

            # Returning data from the buffer, ignoring metadata at the start.
            return r_buff[3:]
